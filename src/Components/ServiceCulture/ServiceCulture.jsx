...
import image from "../../assets/images (12).jpg"; // Replace with an appropriate roommate-related image
            ...
            <div className='space-y-5 my-5'>
                ...
                <div className='space-y-4 ml-6'>
                    <div className='flex gap-3 items-center'>
                        ...
                        <p className='text-lg font-medium text-gray-700'>Smart Matchmaking Based on Preferences</p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <FaShieldAlt size={20} className='text-green-600' />
                        <p className='text-lg font-medium text-gray-700'>Verified Profiles & Secure Interactions</p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <FaComments size={20} className='text-green-600' />
                        <p className='text-lg font-medium text-gray-700'>Real-Time Chat with Potential Roommates</p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <FaMapMarkedAlt size={20} className='text-green-600' />
                        <p className='text-lg font-medium text-gray-700'>Find Rooms Nearby with Location Filters</p>
                    </div>
                </div>
            </div>
        </div>
